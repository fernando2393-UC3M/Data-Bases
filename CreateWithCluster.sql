...
-- ----------------------------------------------------
DROP CLUSTER TITLE_SER;
DROP CLUSTER TITLE_MOV;
DROP CLUSTER ID_CLIENTS;
DROP INDEX IND_TITLE_MOV;
DROP INDEX IND_ID_CONTRACTS;
--DROP INDEX IND_COUNTRY;
DROP INDEX IND_STARTDATE;
...
CREATE INDEX IND_TITLE_MOV ON CLUSTER TITLE_MOV;
CREATE INDEX IND_ID_CLIENTS ON CLUSTER ID_CLIENTS;
CREATE INDEX IND_TITLE_SER ON CLUSTER TITLE_SER;
--CREATE INDEX IND_COUNTRY ON MOVIES(COUNTRY);
CREATE INDEX IND_STARTDATE ON CONTRACTS(STARTDATE);
