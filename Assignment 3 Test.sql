...
INSERT INTO TAPS_MOVIES VALUES(X.CONTRACTID, HOURS, 97, 'AVATAR');
...
DELETE FROM TAPS_MOVIES VALUES(Y.CONTRACTID, HOURS, 97, 'AVATAR');
DELETE FROM TAPS_SERIES VALUES(Y.CONTRACTID, HOURS, 97, 'HOUSE', 1, 3);
DELETE FROM TAPS_SERIES VALUES(Y.CONTRACTID, HOURS, 97, 'BREAKING BAD', 5, 1);
DELETE FROM TAPS_SERIES VALUES(Y.CONTRACTID, HOURS, 97, 'MAD MEN', 1, 2);
END LOOP;
