...
--HERE WE HAVE TO DO THE INSERTS

INSERT INTO TAPS_MOVIES VALUES('PH12030', TO_DATE(TO_NUMBER(TO_CHAR(SYSDATE, 'HH24'))-3), 97, 'AVATAR');
INSERT INTO TAPS_SERIES VALUES('PH34322', TO_DATE(TO_NUMBER(TO_CHAR(SYSDATE, 'HH24'))-3), 97, 'HOUSE', 1, 3);
INSERT INTO TAPS_SERIES VALUES('PH93820', TO_DATE(TO_NUMBER(TO_CHAR(SYSDATE, 'HH24'))-3), 97, 'BREAKING BAD', 5, 1);
INSERT INTO TAPS_SERIES VALUES('PH89402', TO_DATE(TO_NUMBER(TO_CHAR(SYSDATE, 'HH24'))-3), 97, 'MAD MEN', 1, 2);
